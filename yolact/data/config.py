...
COCO_CLASSES =  ("short sleeve top", "long sleeve top", 'short sleeve outwear', 'long sleeve outwear',
...
XBONE_dataset = dataset_base.copy({
    'name': 'XBONE',

    'train_images': '/home/edabk/yolact/data/Xray_newest/train/',
    'valid_images': '/home/edabk/yolact/data/Xray_newest/val/',
    
    'train_info': '/home/edabk/yolact/data/Xray_newest/annotations/instances_train.json',
    'valid_info': '/home/edabk/yolact/data/Xray_newest/annotations/instances_val.json',
...
yolact_base_config = coco_base_config.copy({
    ...
    # Dataset stuff
    'dataset': XBONE_dataset,
    #'num_classes': len(XBONE_dataset.class_names) + 1,
    'num_classes': 13 + 1,
    # Image Size
    'max_size': 550,
    
    # Training params
    'lr_steps': (14000, 30000, 35000, 37000),
    'max_iter': 40000,
